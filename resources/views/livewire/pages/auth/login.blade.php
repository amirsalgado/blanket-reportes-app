...
// Eliminamos la referencia a la clase que ya no existe.
...
new class extends Component {
    ...
    public function login(): void
    {
        ...
        $this->redirect(session('url.intended', '/dashboard'), navigate: true);
    }
}; ?>
...
<div class="min-h-screen flex">
    ...
    <div class="hidden lg:flex w-1/2 bg-blanket-blue p-12 flex-col justify-center items-center text-white relative">
        ...
        <div class="absolute inset-0 bg-cover bg-center opacity-10"
            style="background-image: url('https://images.unsplash.com/photo-1487017159836-4e23ece2e4cf?q=80&w=2071&auto=format&fit=crop')">
        </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center bg-gray-100 p-8">
        <div class="w-full max-w-md">
            ...
            <form wire:submit="login">
                ...
                <div class="flex items-center justify-between mt-6">
                    <label for="remember" class="flex items-center">
                        <input wire:model="remember" id="remember" type="checkbox"
                            class="rounded border-gray-300 text-blanket-blue shadow-sm focus:ring-blanket-blue"
                            name="remember">
                ...
                <div class="mt-8">
                    <x-primary-button
                        class="w-full justify-center py-3 bg-blanket-yellow hover:bg-blanket-yellow-dark text-blanket-blue font-bold text-base">
                        {{ __('Iniciar Sesión') }}
                    </x-primary-button>
                </div>
            </form>
